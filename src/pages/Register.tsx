    ...
    >
      ...
      <Card className="w-full max-w-md bg-slate-900/80 backdrop-blur-xl border-slate-800 shadow-2xl relative z-10">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-white tracking-tight">Ro'yxatdan o'tish</CardTitle>
          <CardDescription className="text-slate-400">
            Yangi hisob yarating va dunyoni 3D formatda kashf eting
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col space-y-4">
            <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-500 text-white shadow-lg shadow-blue-600/20 h-11">Ro'yxatdan o'tish</Button>
